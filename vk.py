...
def vk_apply():
    ...
    def send_remind_message(user_id):
        ...
        if get_state(user_id) != "quest8":
            write_msg(user_id, f"Здравствуйте, сезон работ уже стартовал, а мы по-прежнему ищем талантливых авторов, готовых работать в нашей команде Наталья Денисенко - group. Не откладывайте ваши возможности на потом, с нетерпением ждем вашу анкету. Следуйте инструкциям бота.", None)
